...
\marginnote{For a finite set $E$, the notation $\cP(E)$ stands for the $\sigma$-field corresponding to the set of all the parts of $E$.}
...
A proof of~\eqref{eq:gaussian_queue} can be treated as an exercice.
\begin{definition}
