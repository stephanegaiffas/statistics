...
\begin{proof}
	We have $\bS + v v^\top \mgeq \bS \succ 0$ so that $\bS + v v^\top$ is invertible and using the Sherman-Morrison formula, we have
	\begin{equation*}
	...
	\end{align*}
	which concludes the proof of Lemma~\ref{lem:sherman-morrison}.
\end{proof}
This proves in particular that $\wh \ell_{n+1} \in [0, 1)$ almost surely since $\wh \bSigma \succ 0$ almost surely.
Now, using Lemma~\ref{lem:sherman-morrison} we obtain
\begin{align*}
