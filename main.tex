...
\section{Identifiable and dominated models} % (fold)
...
A more interesting example of non-identifiable model is given by \emph{mixture models}, such as the Gaussian mixture model, where we consider a distribution on $\R^d$ with density
