...
\sidenote{weighted by the sample proportions $n_i / n$}
...
\todo{Talk about $R^2$ here, check slides from Agathe supposing $\bone \in \spa(\bX)$}

\todo{Talk bout studentized residuals ?}
